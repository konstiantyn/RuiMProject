...
<body>
	...
	<section class="contaneSection">
		<div class="container">
			<div class="row">
			<h1 class="titleh1">Playlist Messages</h1>
			...
			<div class="bottom-btns">
				<a href="#" class="add-video-btn ic-applay-message"><span>Applay Message</span></a>
				<a href="#" class="del-video-btn ic-delete-message"><span>Delete Message</span></a>
