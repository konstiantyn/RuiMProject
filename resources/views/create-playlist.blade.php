	...
	<section class="contaneSection">
		<div class="container">				
				...
				<div class="col-sm-12 select-box create-playlist">
					<div class="row edit-playlist-section">
						<div class="col-xs-7 col-sm-4 col-md-4">
							<input type="text" placeholder="Project Name" class="input">
						</div><!--col-4-->
						...
						<div class="col-xs-12 col-sm-6 col-md-6">
							<select class="form-control" id="#">
								<option>Kalum Sunset</option>
								<option>Kalum Sunset 1</option>
								<option>Kalum Sunset 2</option>
								<option>Kalum Sunset 3</option>
								<option>Kalum Sunset 4</option>
								<option>Kalum Sunset 5</option>
								<option>Kalum Sunset 6</option>
							</select>
						</div><!--col-6-->
			...
			<div class="bottom-btns">
				<a href="#" class="add-video-btn ic-edit-project"><span>Edit Selected Playlist</span></a>
			</div>
		</div><!--container-fluid-->
	</section><!--sectionhome-->
