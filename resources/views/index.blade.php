    ...
    <section class="contaneSection">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <select class="form-control" id="#">
                                ...
                                <option>Project Name 5</option>
                                <option>Project Name 6</option>
                            </select>
                        </div><!--col-6-->
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <select class="form-control" id="#1">
                                ...
                                <option>Playlist Name 4</option>
                                <option>Playlist Name 5</option>
                                <option>Playlist Name 6</option>
                            </select>
                        </div><!--col-6-->
                        <div class="col-xs-6 col-sm-6 col-md-6">
            ...
            <div class="project-input">
                <input type="text" placeholder="Project URL(https:\\suisse-view.com\videoclips\foldername\filename.)">
            </div>
        </div><!--container-fluid-->
    </section><!--sectionhome-->
