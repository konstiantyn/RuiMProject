...
Route::get('url_login', function(){return view('login', array('error_msg_logpassword' => '','error_msg_loginuser' =>''));})->name('name_login');
Route::get('url_signup', function(){return view('signup', array('error_msg_signup' => ''));});
